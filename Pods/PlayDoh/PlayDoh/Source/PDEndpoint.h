...
@protocol PDParameterEncodableType <NSObject>
@end
@interface NSDictionary () <PDParameterEncodableType>
@end
@interface NSArray () <PDParameterEncodableType>
@end

@interface PDEndpoint : NSObject
/**
 ...
 */
@interface PDEndpoint (Networking)
...
@interface PDSlugMapping : NSObject
/**
...
@interface PDEndpoint (HeaderMapping)
/**
