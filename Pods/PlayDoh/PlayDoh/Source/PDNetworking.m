...
+ (NSString *)completeUrlForEndpoint:(PDEndpoint *)endpoint {
...
+ (AFHTTPRequestOperationManager *)operationManagerWithEndpoint:(PDEndpoint *)endpoint {
...
af_networkSuccessBlock successBlock(PDEndpoint *endpoint, dv_responseBlock completion) {
    /*
...
af_networkFailureBlock failureBlock(PDEndpoint *endpoint, dv_responseBlock completion) {
