...
NSString * const ShuttleRouteEntityName = @"ShuttleRouteCache2";
NSString * const ShuttleStopEntityName = @"ShuttleStopLocation2";
NSString * const ShuttleRouteStopEntityName = @"ShuttleRouteStop2";
