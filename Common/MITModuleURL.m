...
- (void) setPathWithViewController:(UIViewController *)viewController extension:(NSString *)extension {
	UIViewController *parentController = [[[MIT_MobileAppDelegate applicationDelegate] moduleWithTag:moduleTag] parentForViewController:viewController];
...
- (void) setAsModulePath {
	MITModule *module = [[MIT_MobileAppDelegate applicationDelegate] moduleWithTag:moduleTag];
