...
NSString* const MITCalendarPathPattern = @"apis/calendars/:calendar";

#pragma mark calendars/:calendar/events
NSString* const MITCalendarEventsResourceName = @"MITCalendarEventsResourceName";
NSString* const MITCalendarEventsPathPattern = @"apis/calendars/:calendar/events";

#pragma mark calendars/:calendar/events/:event
NSString* const MITCalendarEventResourceName = @"MITCalendarEventResourceName";
NSString* const MITCalendarEventPathPattern = @"apis/calendars/:calendar/events/:event";
...
NSString* const MITDiningHouseVenuesResourceName = @"MITDiningHouseVenuesResourceName";
NSString* const MITDiningHouseVenuesPathPattern = @"apis/dining/venues/house";

#pragma mark dining/venues/retail
NSString* const MITDiningRetailVenuesResourceName = @"MITDiningRetailVenuesResourceName";
NSString* const MITDiningRetailVenuesPathPattern = @"apis/dining/venues/retail";

#pragma mark links
NSString* const MITLinksResourceName = @"MITLinksResourceName";
NSString* const MITLinksPathPattern = @"apis/links";

#pragma mark maps/bootstrap
NSString* const MITMapBootstrapResourceName = @"MITMapBootstrapResourceName";
NSString* const MITMapBootstrapPathPattern = @"apis/map/bootstrap";
...
NSString* const MITMapBuildingPathPattern = @"apis/map/rooms/:building";
...
NSString* const MITPersonPathPattern = @"apis/people/:person";
...
NSString* const MITShuttlesRoutePathPattern = @"apis/shuttles/routes/:route";
...
NSString* const MITTechcashPathPattern = @"apis/techcash";

#pragma mark techcash/accounts
NSString* const MITTechcashAccountsResourceName = @"MITTechcashAccountsResourceName";
NSString* const MITTechcashAccountsPathPattern = @"apis/techcash/accounts";
