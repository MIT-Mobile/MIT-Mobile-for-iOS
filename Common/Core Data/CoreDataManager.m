...
- (NSManagedObjectModel *)managedObjectModel {
	...
	NSArray *allModels = [NSArray arrayWithObjects:@"Stellar", @"PeopleDataModel", @"News", @"Emergency", @"ShuttleTrack", @"Calendar", @"CampusMap", @"Tours", @"Anniversary", @"QRReaderResult", nil];
