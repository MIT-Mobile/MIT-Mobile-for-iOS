...
- (void)presentIPadCalloutForAnnotationView:(MKAnnotationView *)annotationView
{
    ...
    MITMobiusDetailContainerViewController *detailContainerViewController = [[MITMobiusDetailContainerViewController alloc] initWithResource:resource resources:self.resourcesByBuilding[resource.room] nibName:nil bundle:nil];
