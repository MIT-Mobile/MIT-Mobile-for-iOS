...
- (void)mapView:(MKMapView *)mapView didUpdateUserLocation:(MKUserLocation *)userLocation {
    ...
    switch (arc4random() % 4) {
        case 0:
            ...
            DDLogVerbose(@"Pretending that we are in n42");
            break;
        case 1:
            coord.latitude = 42.3629;
            coord.longitude = -71.0862;
            DDLogVerbose(@"Pretending that we are in kendall square");
            break;
        default:
            coord.latitude = 42.3948;
            coord.longitude = -71.1446;
            DDLogVerbose(@"Pretending that we are in alewife");
            break;
    }
