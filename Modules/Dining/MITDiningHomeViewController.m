...
- (void)setupNavigationBar
{
    ...
    self.menuBarButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:MTImageBarButtonMenu] style:UIBarButtonItemStylePlain target:self action:@selector(menuButtonPressed)];
