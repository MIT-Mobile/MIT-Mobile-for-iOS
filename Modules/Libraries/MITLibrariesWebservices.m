...
+ (void)getResultsForSearch:(NSString *)searchString startingIndex:(NSInteger)startingIndex completion:(void (^)(NSArray *items, NSError *error))completion
{
    ...
    [parameters setObject:[NSString stringWithFormat:@"%ld", (long)startingIndex] forKey:kMITLibraryWebservicesStartIndexKey];
    [parameters setObject:searchString ? searchString : @"" forKey:kMITLibraryWebservicesSearchTermKey];
    [parameters setObject:[NSString stringWithFormat:@"%ld", (long)kMITLibrariesSearchResultsLimit]  forKey:kMITLibraryWebservicesLimitKey];
